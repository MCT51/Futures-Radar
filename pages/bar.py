...
if not _DATASET_OPTIONS:
                ...
                [
                    ...
                    html.Div(
                        [
                            ...
                            html.Button("Refresh datasets", id="bar-refresh-datasets", style={"marginLeft": "12px"}),
                        ],
    ...
    @callback(
        Output("bar-dataset", "options"),
        Output("bar-dataset", "value"),
        Input("bar-refresh-datasets", "n_clicks"),
        State("bar-dataset", "value"),
    )
